...
class FollowUpsController extends Controller implements HasMiddleware
{
    ...
    public function store(Request $request, Client $client)
    {
        ...
        return redirect()->route('clients.followups.index', $client)->with('success', 'Seguimiento creado exitosamente.');
    }
    ...
    public function update(Request $request, Client $client, $followUpId)
    {
        ...
        return redirect()->back()->with('success', 'Seguimiento actualizado exitosamente.');
    }
}
